      ...
      <div className="max-w-7xl mx-auto px-10 pt-10 pb-20">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-brand-muted max-w-2xl leading-relaxed mb-6">
            ...
            <span className="text-white font-medium">{data.title}</span> interview questions and
            take an AI‑powered practice interview.
          </p>

          {/* CTA */}
          <button
            onClick={() => router.push(`/dashboard/ai-interview/${slug}/session`)}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white text-black text-xs font-bold shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:bg-white/90 active:scale-95 transition-all"
          >
            <Mic size={13} />
          ...
          <div className="lg:w-56 flex-shrink-0">
            <div className="lg:sticky lg:top-24">
              ...
              <p className="text-xl md:text-2xl font-display font-bold text-white leading-snug">
                ...
                <span className="text-brand-muted font-normal">{data.title} interview questions</span>
              </p>
            </div>
          </div>
        ...
        <div className="mt-20 relative rounded-3xl overflow-hidden border border-white/[0.08] bg-white/[0.02]">
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-8 py-16">
            ...
            <p className="text-sm text-brand-muted max-w-md leading-relaxed mb-8">
              ...
              specifically for the <span className="text-white">{data.title}</span> role.
            </p>
            <button
              onClick={() => router.push(`/dashboard/ai-interview/${slug}/session`)}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-black text-sm font-bold shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:bg-white/90 active:scale-95 transition-all"
            >
              <Mic size={14} />
              Start now
            </button>
