          ...
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1">
            {SUBJECTS.map(s => (
              <button
                ...
                className={`flex-shrink-0 px-5 py-1.5 rounded-full text-xs font-semibold tracking-tight transition-all duration-300 border ${subject === s
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {TOPICS[subject].map(t => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-xs font-semibold tracking-tight transition-all duration-300 border ${topic === t
          ...
          {DIFFICULTIES.map(d => {
            ...
            return (
              <button
                key={d}
                disabled={locked}
                className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-tight transition-all duration-300 border ${d === "Easy"
                    ? "bg-white text-black border-white shadow-[0_0_15px_rgba(255,255,255,0.15)]"
            ...
            {questions.map((q, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`rounded-2xl border p-5 transition-all duration-300 ${isChecked
                ...
                >
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    <div className={`flex-shrink-0 w-6 h-6 rounded-md border flex items-center justify-center transition-all duration-300 ${isChecked
                    ...
                    <p className={`text-sm font-medium leading-relaxed transition-colors ${isChecked ? "text-brand-muted line-through decoration-white/20" : "text-white"
                      }`}>
                      {q}
                    </p>
                  </div>
                  ...
                  <div className="flex justify-end mt-3">
                    <button
                      ...
                      disabled={isChecked}
                      className={`px-5 py-2 rounded-full text-xs font-bold tracking-tight transition-all duration-300 ${isChecked
